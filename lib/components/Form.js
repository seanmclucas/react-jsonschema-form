...
var Form = function (_Component) {
  ...
  _createClass(Form, [{
    ...
    key: "renderTopErrors",
    value: function renderTopErrors() {
    ...
    key: "renderBottomErrors",
    value: function renderBottomErrors() {
...
Form.defaultProps = {
  ...
  errorListPosition: ERROR_LIST_POSITIONS.BOTTOM
};
...
if (process.env.NODE_ENV !== "production") {
  Form.propTypes = {
    ...
    errorListPosition: _react.PropTypes.oneOf(ERROR_LIST_POSITIONS.TOP, ERROR_LIST_POSITIONS.BOTTOM),
